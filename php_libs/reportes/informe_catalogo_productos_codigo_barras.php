...
//	Consulta tabla Tipo de Factura.
  ...
  $x_descripcion = 50; $x_codigo_barra = 12;
          ...
          $pdf->RotatedTextMultiCell($x_descripcion,$y,utf8_decode($descripcion),0);
          //$pdf->Cell($ancho[2],$alto[0],utf8_decode(substr($descripcion,0,120)),0,1,'L',$fill);
          ...
          if($salto == 15){
            $x_codigo_barra = $x_codigo_barra + 90;
            $x_descripcion = $x_descripcion + 90;
            $y = 32;
					}
